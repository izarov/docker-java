...
public class ResizeContainerCmdExec extends AbstrSyncDockerCmdExec<ResizeContainerCmd, Void> implements
    ...
    protected Void execute(ResizeContainerCmd command) {
        WebTarget webTarget = getBaseResource().path("/containers/{id}/resize").resolveTemplate("id",
